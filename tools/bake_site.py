...
# Regenerate build timestamp header so webserver.cpp always reflects the real build time
ts = datetime.datetime.now().strftime("%b %d %Y %H:%M:%S")
header_path = os.path.join("include", "build_timestamp.h")
with open(header_path, "w") as f:
    f.write(f'#pragma once\n// Auto-generated by tools/bake_site.py — do not edit\n#define BUILD_TIMESTAMP "{ts}"\n')
